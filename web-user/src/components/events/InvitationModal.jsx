...
export default function InvitationModal({ isOpen, event, onClose, onRespond }) {
  ...
  // Safely access participants with fallbacks
  const participants = {
    departments: event.participants?.departments ?? [],
    offices: event.participants?.offices ?? [],
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={event.title}>
      <div className={styles.detailsGrid}>
        ...
        <div className={styles.detailItem}>
          <FiEye size={15} /> {event.visibility}
        </div>
        <div className={styles.detailItem}>
          <FiMapPin size={15} /> {event.venue || event.location || "Online"}
        </div>
        <div className={styles.detailItem}>
          <FiUser size={15} /> {event.method}
        </div>
      </div>
      ...
      <div className={styles.section}>
        <h3>
          <FiCalendar size={15} /> Description
        </h3>
        ...
        <div className={styles.partGroup}>
          ...
          <div className={styles.partList}>
            ...
            {participants.departments.length > 3 && (
              ...
              >
                {showAllDept ? "Show less" : "Show all"}{" "}
        ...
        <div className={styles.partGroup}>
          ...
          <div className={styles.partList}>
            ...
            {participants.offices.length > 3 && (
              ...
              >
                {showAllOffice ? "Show less" : "Show all"}{" "}
                <FiChevronDown size={13} />
              </button>
            )}
          </div>
        ...
        <div className={styles.partGroup}>
          ...
          <div className={styles.partList}>
            ...
            {participants.users.length > 3 && (
              ...
              >
                {showAllUser ? "Show less" : "Show all"}{" "}
                <FiChevronDown size={13} />
              </button>
            )}
          </div>
      ...
      <div className={styles.archiveSection}>
        <button type="button" className={styles.archiveBtn}>
