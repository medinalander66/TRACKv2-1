...
async function seed() {
  ...
  // ─── Positions (order = priority, lower number = higher priority) ──
  const samplePositions = [
    { name: 'Chancellor', order: 0, allow_multiple: false },
    { name: 'Vice Chancellor', order: 1, allow_multiple: true },
    { name: 'Dean', order: 2, allow_multiple: true },
    { name: 'Associate Dean', order: 3, allow_multiple: true },
    { name: 'Head of Office', order: 4, allow_multiple: true }
  ];
